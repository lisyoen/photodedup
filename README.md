...
|---------|------|---------|
| v0.1.9 | 2026-07-25 | Added background updates that defer during active work and a version badge that restarts the app when the update is ready. |
| v0.1.8 | 2026-07-25 | Fixed Space/Enter confirmation in the Apply All dialog opened with Ctrl+S. |
| v0.1.7 | 2026-07-24 | Version click opens release notes. |
| v0.1.6 | 2026-07-24 | Periodic update check and persistent toasts. |
