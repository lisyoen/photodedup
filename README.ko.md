...
| 버전 | 날짜 | 요약 |
|------|------|------|
| v0.1.9 | 2026-07-25 | 작업 중에는 보류되는 백그라운드 업데이트와, 업데이트 완료 후 앱을 재시작하는 버전 배지를 추가했습니다. |
| v0.1.8 | 2026-07-25 | Ctrl+S로 연 전체 적용 대화상자에서 Space/Enter 확인이 동작하도록 수정했습니다. |
| v0.1.7 | 2026-07-24 | 버전 클릭 시 릴리즈노트로 이동합니다. |
| v0.1.6 | 2026-07-24 | 1분 주기 업데이트 체크와 60초 토스트를 추가했습니다. |
| v0.1.5 | 2026-07-24 | 전체 적용 Ctrl+S 단축키를 추가했습니다. |
